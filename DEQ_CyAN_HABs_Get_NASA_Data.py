...
for i in range(0, (hab_days_length)):
    ...
    shutil.copyfile(os.path.join(archive_dir[i], file2[i] + '_1_1.tif'), os.path.join(temp_dir[i], file2[i] + '_1_1.tif'))
    shutil.copyfile(os.path.join(archive_dir[i], file2[i] + '_1_2.tif'), os.path.join(temp_dir[i], file2[i] + '_1_2.tif'))
    shutil.copyfile(os.path.join(archive_dir[i], file2[i] + '_2_1.tif'), os.path.join(temp_dir[i], file2[i] + '_2_1.tif'))
    shutil.copyfile(os.path.join(archive_dir[i], file2[i] + '_2_2.tif'), os.path.join(temp_dir[i], file2[i] + '_2_2.tif'))
