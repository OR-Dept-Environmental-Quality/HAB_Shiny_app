---
title: "Satellite Imagery of Cyanobacteria in Oregon Lakes and Reservoirs - User Guide"
output:
...
The application provides Cyanobacteria mapping data with time series data visualization for Oregon Lakes and Reservoirs. The map application uses satellite data from the [U.S. EPA CyAN Project][CyAN]. This guide describes the application features and steps for using the application.
